...
type ClusterTemplate struct {
	...
	// BundleSSHKeyRef references a Secret (in the ClusterInstance's namespace) containing the
	...
	// "id_ecdsa", "ssh-privatekey", or "id_rsa". This field is a FALLBACK. When CRCVersion is set,
